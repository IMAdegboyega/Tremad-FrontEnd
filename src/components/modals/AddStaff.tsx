...
// AddStaffModal
// Purpose:
// - Guided, three-step wizard to collect new staff data
...
interface StaffData {
  ...
  // Step 3: Guardian info (Next of Kin)
  name: string;
  relationship: string;
  phoneNumber2: string;
  email2: string;
...
const AddStaffModal: React.FC<AddStaffModalProps> = ({
  ...
  // currentStep: 1 -> Staff details, 2 -> Academic info, 3 -> Guardian info
      ...
      {!showSuccess ? (
        <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full">
          ...
          <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <button className="w-full px-3 py-2 text-left border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent flex justify-between items-center">
                        <span className={formData.assignedSubjects ? 'text-gray-900' : 'text-gray-400'}>
                          {formData.assignedSubjects || 'Select subjects'}
                        </span>
                        <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                        </svg>
                    ...
                    <DropdownMenuContent className="w-full max-h-60 overflow-y-auto">
                      {subjects.map(subject => (
                        <DropdownMenuItem 
                          key={subject}
                          onClick={() => handleInputChange('assignedSubjects', subject)}
                        >
                          {subject}
                        </DropdownMenuItem>
                      ))}
                ...
                <div>
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <button className="w-full px-3 py-2 text-left border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent flex justify-between items-center">
                        <span className={formData.classAssigned ? 'text-gray-900' : 'text-gray-400'}>
                          {formData.classAssigned || 'Select section'}
                        </span>
                        <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                        </svg>
                    ...
                    <DropdownMenuContent className="w-full max-h-60 overflow-y-auto">
                      {classLevels.map(classLevel => (
                        <DropdownMenuItem 
                          key={classLevel}
                          onClick={() => handleInputChange('classAssigned', classLevel)}
                        >
                          {classLevel}
                        </DropdownMenuItem>
                      ))}
            ...
            {/* Step 3: Guardian and emergency contacts (Next of Kin) */}
            {currentStep === 3 && (
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
